                  ...
                  <div class="card-body">
                    ...
                    <form method ="get" action="{{ URL::to('/') }}" class="forms-sample" name="add_bill" id="add_bill">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <button type="submit" style="width:50%;font-size:20px;" class="btn btn-gradient-primary mr-2">เพิ่มคิวรถ</button>
                        </div>
                        <div class="col-md-3"></div>
                        <div class="col-md-12"><br /></div>
                        <div class="col-md-3"></div>
                        <div class="col-md-12">
                          <button style="width:50%;font-size:20px;" class="btn btn-light">ยกเลิก</button>
                        </div>
                          <div class="col-md-3"></div>
                      </div>
